...
if not os.path.exists('augmented_dataset/split_1'):
    os.makedirs('augmented_dataset/split_1')

if not os.path.exists('augmented_dataset/split_2'):
    os.makedirs('augmented_dataset/split_2')

if not os.path.exists('augmented_dataset/split_3'):
    os.makedirs('augmented_dataset/split_3')

print("Writing datasets to split folders...")

split_1_train = pd.concat([df1, df2])
split_1_test = df3
split_1_train.to_csv('augmented_dataset/split_1/train.csv', index=False)
split_1_test.to_csv('augmented_dataset/split_1/test.csv', index=False)

split_2_train = pd.concat([df2, df3])
split_2_test = df1
split_2_train.to_csv('augmented_dataset/split_2/train.csv', index=False)
split_2_test.to_csv('augmented_dataset/split_2/test.csv', index=False)

split_3_train = pd.concat([df3, df1])
split_3_test = df2
split_3_train.to_csv('augmented_dataset/split_3/train.csv', index=False)
split_3_test.to_csv('augmented_dataset/split_3/test.csv', index=False)
